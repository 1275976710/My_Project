										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR 		
													...
													<TD>
													<!--数据中心对象ActionContext被放入值栈的context域中，所有提交的参数在一个map中  -->
